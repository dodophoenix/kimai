    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td class="description <?php if (isset($this->disabled_columns['description'])):?> disabled <?php endif; ?>"><a onClick="export_toggle_column('description');"><?php echo $this->kga['lang']['description']?></a></td>
